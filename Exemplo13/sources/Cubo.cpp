...
int Cubo::init(GLFWwindow* window) {
    ...
    */
    ...
    this->cubePositions.push_back(new glm::vec3(0.0f, 1.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(0.0f, 2.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(0.0f, 3.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(0.0f, 4.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(0.0f, 5.0f, 0.0f));
    
	this->cubePositions.push_back(new glm::vec3(-1.0f, 0.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(-1.0f, 1.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(-1.0f, 2.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(-1.0f, 3.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(-1.0f, 4.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(-1.0f, 5.0f, 0.0f));

	this->cubePositions.push_back(new glm::vec3(0.0f, 6.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(1.0f, 6.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(3.0f, 6.0f, 0.0f));

    this->cubePositions.push_back(new glm::vec3(2.0f, 7.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(3.0f, 7.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(1.0f, 7.0f, 0.0f));
    
    this->cubePositions.push_back(new glm::vec3(4.0f, 6.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(4.0f, 5.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(4.0f, 4.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(4.0f, 3.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(4.0f, 2.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(4.0f, 1.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(4.0f, 0.0f, 0.0f));
	
    this->cubePositions.push_back(new glm::vec3(5.0f, 5.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(5.0f, 4.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(5.0f, 3.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(5.0f, 2.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(5.0f, 1.0f, 0.0f));
	this->cubePositions.push_back(new glm::vec3(5.0f, 0.0f, 0.0f));
    
    this->cubePositions.push_back(new glm::vec3(1.0f, 2.0f, 0.0f));
    this->cubePositions.push_back(new glm::vec3(2.0f, 2.0f, 0.0f));
