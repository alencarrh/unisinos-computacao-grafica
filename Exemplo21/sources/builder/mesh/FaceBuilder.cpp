#include "../../headers/builder/mesh/FaceBuilder.h"

FaceBuilder::FaceBuilder(MeshMediator* mediator) {
    this->mediator = mediator;
}

FaceBuilder::~FaceBuilder() {}

void FaceBuilder::process(stringstream& line) {
    string token;
    ...
    if (vertices.size() == 3) {
        ...
        this->mediator->callbackFace(face);
        return;
    }
    ...
    if (vertices.size() == 4) {
        ...
        this->mediator->callbackFace(face1);
        this->mediator->callbackFace(face2);
    }
}
