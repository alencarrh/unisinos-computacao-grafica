...
int main() {
    ...
    light->ambient = new glm::vec3(0.8f, 0.8f, 0.8f);
    light->diffuse = new glm::vec3(1.4f, 1.4f, 1.4f);
    light->specular = new glm::vec3(1.8f, 1.8f, 1.8f);
    ...
    // scene->addObj(new Object("bmw.obj", new glm::vec3(0.0f, 0.0f, 0.0f)));
